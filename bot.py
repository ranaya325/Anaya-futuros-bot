...
def send_telegram(msg):
    try:
        text = urllib.parse.quote(f"🤖 ANAYA FUTUROS\n{msg}")
        url  = f"https://api.telegram.org/bot{TELEGRAM_TOKEN}/sendMessage?chat_id={TELEGRAM_CHAT}&text={text}"
